...
export default function Header(props) {
  return (
    <>
                    ...
                    <div className="flex space-x-4">
                      {navigation.map((pages) => (
                        <NavLink
                          ...
                          className={({ isActive }) => {
                            return (
                              "px-3 py-2 no-underline rounded-md text-sm font-medium " +
                              (isActive
              ...
              <div className="space-y-1 px-2 pt-2 pb-3 ">
                {navigation.map((item) => (
                  <NavLink
                    ...
                    className={({ isActive }) => {
                      return (
                        "px-3 py-2 rounded-md block text-base font-medium " +
                        (isActive
      ...
      <div className="bg-gray-400 min-h-screen px-3 py-2 sm:px-1 sm:py-2">
        {props.children}
      </div>
    </>
  );
