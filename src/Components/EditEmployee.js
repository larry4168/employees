    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>Edit Employee`s</Modal.Title>
        </Modal.Header>
        <Modal.Body>
        <form 
          onSubmit={(e) => {
        ...
        <Modal.Footer>
          ...
          <button form='editbutton' className='px-3 py-2 text-sm text-purple-600 font-semibold rounded border border-purple-300 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-1 focus:ring-purple-600 focus:ring-offset-2' >
            Update
          </button>
        </Modal.Footer>
      </Modal>
